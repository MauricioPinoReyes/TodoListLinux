...
## Usuarios creados para pruebas del proyecto
## Usename: admin password: 1234
## Username: jhon password: joh#12371
## Username: maria password: mari%34345543
    ...
    def get_context_data(self, **kwargs):
        ...
        if search_input:
            context['tasks'] = context['tasks'].filter(
                title__contains=search_input)  # utilizar title__startwith para buscar por la primera letra
